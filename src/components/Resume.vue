			...
			<div class="nine columns main-col">
				...
				<div class="bars">
					<ul class="skills">
						...
						<li>
							<span class="bar-expand html5 wow fadeInLeft"></span>
							<em>HTML5</em>
						</li>
						<li>
				...
				experience: [
					{
						...
						job: 'Web前端开发工程师',
						jobContent: [
							'负责研发并维护中国铁塔广西分公司社会资源管理平台，通过GIS地图获取杆塔资源方位，实时监控杆塔资源变化',
							'负责研发并维护智慧城市资源生态平台，通过GIS地图获取灯杆方位，实时监控灯杆变化，及时派送工单予工人维护',
							'负责研发并维护广西壮族自治区住房与城乡建设云平台，实现住建厅各门户统一登陆和、监控大屏展示和数据共享',
							'负责研发广西生活污水垃圾处理设施建设运营管理信息平台，主要负责动态表单功能和自定义模板配置',
						]
					},
					{
